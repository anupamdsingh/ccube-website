...
function sidebar() {
  return (
    <div className="w-72 bg-[#1c212c] min-h-full h-screen flex flex-col items-center pt-5 pb-2 space-y-7">
      <div className="w-full pr-3 flex flex-col gap-y-1 text-gray-500 fill-gray-500 text-sm">
        ...
        <div className="w-full flex items-center gap-x-1.5 group select-none">
          <div className="w-1 rounded-xl h-8 bg-transparent transition-colors duration-200 relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-[102%] group-hover:translate-y-0 translate-y-0 bg-indigo-500 transition-all duration-300"></div>
          </div>
          <div
          ...
          >
            <svg
              className="h-5 w-5 !fill-blue-500 group-hover:fill-indigo-500 dark:fill-gray-600  transition-colors duration-200"
        ...
        <div className="w-full flex items-center gap-x-1.5 group select-none">
          <div className="w-1 rounded-xl h-8 bg-transparent transition-colors duration-200 relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-[102%] translate-y-full group-hover:translate-y-0 bg-indigo-500 transition-all duration-300"></div>
          </div>
          <div
          ...
          >
            <svg
              className="h-5 w-5 group-hover:fill-indigo-500 dark:fill-gray-600 transition-colors duration-200"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
              <g>
                <path d="M9.29 7.71L13.59 12l-4.3 4.29a1 1 0 1 0 1.42 1.42l5-5a1 1 0 0 0 0-1.42l-5-5a1 1 0 0 0-1.42 1.42z"></path>
              </g>
            </svg>
        ...
        <div className="w-full flex items-center gap-x-1.5 group select-none">
          ...
          >
            ...
            <span className="font-QuicksandMedium">Application</span>
          </div>
        </div>
      </div>
